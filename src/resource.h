...
namespace cg
{
	...
	struct unsigned_color
	{
		...
		{
			unsigned_color out{};
			float3 preproccessed = linalg::clamp(255.f * color, 0.f, 255.f);
			out.r = static_cast<int>(preproccessed.x);
			out.g = static_cast<int>(preproccessed.y);
			out.b = static_cast<int>(preproccessed.z);
